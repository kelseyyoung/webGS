...
<?php include_once(view_url().'templates/page_begin.php'); ?>
  ...
  <div class="row-fluid">
    <div class="span6 offset3 well">
      <h2 class="text-center">Create an instructor</h2>
      <?php
        $attr = array('class' => 'form-horizontal'); 
        echo form_open('instructors/create', $attr) ?>
        ...
        <div class="form-actions">
          <button class="btn btn-primary" type="submit" name="submit">Create Instructor</button>
        </div>
