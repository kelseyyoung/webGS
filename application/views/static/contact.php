  ...
  <div class="row-fluid">
    <div class="span8 offset2">
      ...
      <ul>
        ...
        <li>Any error messages that might have shown</li>
      </ul>
      <p>Despite our thorough testing, we're sure we missed a few things. We appreciate your patience and hopefully the problem will be fixed soon.</p>
      <p>For all other questions/comments, please email the above address.</p>
    </div>
  </div>
